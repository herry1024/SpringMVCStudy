...
<%-- 	<form:form commandName="user" modelAttribute="user" action="AddUser" modelAttribute="user" method="post">      --%>
<%--         id 标签：<form:input path="id" /> --%>
<!-- 		<br /> -->
<%--         input 标签：<form:input path="name" /> --%>
<!-- 		<br /> -->
<%--         password 标签：<form:password path="password" /> --%>
<!-- 		<br /> -->
<%-- 		age 标签：<form:password path="age" /> --%>
<!-- 		<br /> -->
